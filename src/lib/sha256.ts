/**
 * SHA-256 em JS puro (sem dependência nativa): roda igual no app, no web e no
 * Node dos scripts. Usado para derivar identificadores determinísticos —
 * o hash do QR do ingresso Sympla e o id do documento de lead.
 */
